...
class DoGet {
  ...
  void complaint(String complaint, String type, String name, String room , String course) async{
    final ss = await gSheets.spreadsheet(spreadsheetId);
    var sheet = ss.worksheetByTitle("Complaints");
    var data =[complaint,type,name,room,course];
    print(data);
    List<Cell>? cellsRow;
    sheet?.values.appendRow(data);
